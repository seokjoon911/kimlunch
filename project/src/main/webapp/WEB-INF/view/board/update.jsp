...
<form:form modelAttribute="board" action="update" enctype="multipart/form-data" 
    name="updateform">
<input type="hidden" name="file2" value="${board.imgurl}" >
<form:hidden path="bno" />  
<form:hidden path="userid" />
<table class="w3-table-all"><tr><td colspan="2">${boardName}</td></tr>
<tr><td>제목</td><td><form:input path="article"/>
   <form:errors path="article" class="errortext"/>
  </td></tr>
<tr>
  <tr><td>비밀번호</td>
   <td><form:password path="password" /><form:errors path="password" class="errortext"/></td></tr>
<tr><td>첨부파일</td><td>&nbsp;
   <c:if test="${!empty board.imgurl}"> <%-- 수정전에 첨부파일 존재  --%>
     <div id="file_desc"><a href="file/${board.imgurl}">${board.imgurl}</a>&nbsp;
...
<tr><td>내용</td><td>
<form:textarea path="subsistence" cols="67" rows="15"/>
  <script type="text/javascript">
     CKEDITOR.replace("subsistence",{ filebrowserImageUploadUrl : "imgupload"});
  </script>
      <form:errors path="subsistence" class="errortext"/></td></tr>
<tr><td>상호명</td>
	<td ><input type="text" id="pname" class="w3-input" name="pname" value="${board.pname}"></td></tr>
<tr><td>주소</td>
	<td><input type="text" id="paddress" class="w3-input" name="paddress" value="${board.paddress}"></td></tr>
<tr><td>전화번호</td>
	<td><input type="text" id="phone" class="w3-input" name="phone" value="${board.phone}"></td></tr>
<tr><td>위도</td>
	<td><input type="text" id="map_a" class="w3-input" name="map_a" value="${board.map_a}"></td></tr>
<tr><td>경도</td>
	<td><input type="text" id="map_b" class="w3-input" name="map_b" value="${board.map_b}"></td></tr>
<tr><td colspan="2">
<!-- kakao API -->
<div class="map_wrap">
    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div>
                     키워드 : <input type="text" value="${board.pname}" id="keyword" size="15"> 
...
function removeAllChildNods(el) {   
   ...
   <a href="detail?num=${board.bno}">[취소]</a>
